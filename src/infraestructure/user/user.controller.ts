...
export class UserController {
    ...
    @Get(':id')
    @ApiOperation({ summary: "Obtener usuario", description: "Obtiene la información de un usuario" })
    @ApiOkResponse({
    ...
    @Put(':id')
    @ApiOperation({ summary: "Actualizar usuario", description: "Actualiza la información de un usuario nuevo." })
    @ApiOkResponse({
    ...
    @Delete(':id')
    @ApiOperation({ summary: "Eliminar usuario", description: "Elimina la información de un usuario nuevo." })
    @ApiOkResponse({
